...
<%
	Connection connection = null;
 	try {
        ...
        String complaint_name = request.getParameter("compliant_name");
       ...
       PreparedStatement ps = connection.prepareStatement("insert into FIR_Record(FIR_no,Accussed_name,compliant_name,city,contact_no,complain,precint_no) values(?,?,?,?,?,?,?);");
        ps.setString(1,Fir_no);
